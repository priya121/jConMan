...
public class ConManTest {
    ...
    private ContactList createdImportedContacts() {
        ...
        Contact priya = new Contact("Priya", "Patil", "123@gmail.com", "2 Cedar Way", "04.05.06", "123", "www.", consoleIO);
        Contact sarah = new Contact("Sarah", "Smith", "234@gmail.com", "3 Cedar Way", "04.05.06", "123", "www.", consoleIO);
        priya.setExisting();
        sarah.setExisting();
